...
/**
 * Extracts the version of the deployed WAR, reading the properties file packed and generated by maven-archiver. It is heavily inspired from JCloudsVersion extractor.
 * 
 * @author Enric Ruiz
 */
...
{
    /**
     * Matches four groups, the major, the minor and the (optional) patch versions separated by one dot each and followed by any string that begins with '-'
     */
