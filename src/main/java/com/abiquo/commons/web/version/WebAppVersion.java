...
public class WebAppVersion
{
    ...
    public final Properties manifestProperties;

    public final Optional<String> implementationVersion;

    public final Optional<String> gitCommit;
    ...
    private WebAppVersion(final ServletContext servletContext)
    {
        ...
        gitCommit = Optional.ofNullable(manifestProperties.getProperty("Git-Commit"));
    }
